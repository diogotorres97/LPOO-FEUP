...
public abstract class Bomb extends Item {
    ...
    protected Sound explosionSound, placeBombSound;

    private boolean playedExplosionSound;
    ...
    public void createBomb() {
        ...
        placeBombSound = gam.manager.get("sounds/placeBomb.wav", Sound.class);
        if (soundsOn)
            placeBombSound.play();
        initiateVariables();
    ...
    public void update(float dt) {
        super.update(dt);
        if ((stateTime >= 5f / GAMESPEED && stateTime <= endExplosionTime / GAMESPEED) || onFire) {
            ...
            fireUpTiles();
        } else if (stateTime < 5f / GAMESPEED) {
