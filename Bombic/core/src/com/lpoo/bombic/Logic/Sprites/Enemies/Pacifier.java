...
public class Pacifier  extends Enemy {
    /**
     * Constructor
     *
     * @param game
     ...
     * @param y
     */
    public Pacifier(Game game, float x, float y) {
        super(game, x, y);
    ...
    private void createRunDownAnim() {
        ...
        for (int i = 0; i < 6; i++)
            frames.add(new TextureRegion(atlasEnemies.findRegion("pacifier_down"), i * 50, 0, 50, 50));
    ...
    private void createRunUpAnim() {
        ...
        for (int i = 0; i < 6; i++)
            frames.add(new TextureRegion(atlasEnemies.findRegion("pacifier_up"), i * 50, 0, 50, 50));
    ...
    private void createRunRightAnim() {
        ...
        for (int i = 0; i < 6; i++)
            frames.add(new TextureRegion(atlasEnemies.findRegion("pacifier_right"), i * 50, 0, 50, 50));
    ...
    private void createRunLeftAnim() {
        ...
        for (int i = 0; i < 6; i++)
            frames.add(new TextureRegion(atlasEnemies.findRegion("pacifier_left"), i * 50, 0, 50, 50));
    ...
    private void createStandingAnim() {
        standingAnim = new TextureRegion(atlasEnemies.findRegion("pacifier_down"), 0, 0, 50, 50);
    }
