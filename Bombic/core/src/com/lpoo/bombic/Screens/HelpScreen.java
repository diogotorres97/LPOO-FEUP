...
/**
 * Screen that displays an image with controls information
 */
public class HelpScreen extends AbstractScreen {
     ...
     * @param bombicGame
     */
    public HelpScreen(Bombic bombicGame) {
        super(bombicGame);
    }
    ...
    public void show() {
        if (isAndroid)
            backgroundImg = new Image(gam.manager.get("menus/helpAndroidBack.png", Texture.class));
        else
            backgroundImg = new Image(gam.manager.get("menus/helpBack.png", Texture.class));
